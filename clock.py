...
screen.font("bank gothic")

cursors = ["day", "month", "year", "hour", "minute"]
set_clock = False
cursor = 0
last = 0
...
def button(pin):
    global last, set_clock, cursor, day, month, year, hour, minute
    ...
    if pin == button_b:
        ...
        changed = True
        if not set_clock:
            rtc.datetime((day, month, year, 0, hour, minute, second, 0))
